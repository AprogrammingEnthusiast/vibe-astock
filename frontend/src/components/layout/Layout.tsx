import { sharedWebsite, logoutWebsite } from "@/lib/account";
import { toast } from "sonner";
import { accountKey } from "@/lib/account";
import { useEffect, useRef, useState } from 'react';
import { Link, Outlet, useLocation } from 'react-router-dom';
import { ChevronsLeft, ChevronsRight, LogOut, Cog, Menu, Moon, Sparkles, Sun, X } from 'lucide-react';
...
function readCollapsed() { try { return localStorage.getItem(accountKey('va-sidebar')) === 'collapsed'; } catch { return false; } }
function Shell() {
  ...
  const collapse = () => {
    try { localStorage.setItem(accountKey('va-sidebar'), collapsed ? 'expanded' : 'collapsed'); setCollapsed(!collapsed); setStorageError(''); }
